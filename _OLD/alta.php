                                ...
                                <input id="photo-input" type="file">
                                    ...
                                    <div class="campos">
                                        <div class="campo">
                                            ...
                                            <input type="text" id="dni" placeholder="Documento" class="numerico" maxlength="8" >
                                    ...
                                    <div class="campos">
                                        <div class="campo">
                                            ...
                                            <input type="text" placeholder="Nombre" id="nombre" class="notnull" maxlength="100">
                                        </div>
                                        <div class="campo">
                                            <label for="apellido">Apellido</label>
                                            <input type="text" id="apellido" placeholder="Apellido" class="notnull" maxlength="45">
                                        </div>
                                    </div>
                                    <div class="campos">
                                        <div class="campo">
                                            <label for="direccion">Dirección</label>
                                            <input type="text" id="direccion" placeholder="Dirección" maxlength="45">
                                        </div>
                                        
                                        <div class="campo">
                                            <label for="localidad">Localidad</label>
                                            <input type="text" id="localidad" placeholder="Localidad" class="notnull" maxlength="45">
                                        </div>
                                        
                                        <div class="campo">
                                            <label for="provincia">Provincia</label>
                                            <input type="text" id="provincia" placeholder="Provincia" maxlength="45">
                                        </div>
                                    </div>                   
                                    <div class="campos">
                                        <div class="campo">
                                            <label for="cp">Codigo Postal</label>
                                            <input type="number" id="cp" min="0" max="99999">                               
                                        </div>
                                    </div>
                                    <div class="campos">
                                        <div class="campo">
                                            <label for="nacionalidad">Nacionalidad</label>
                                            <input type="text" id="nacionalidad" placeholder="Nacionalidad" maxlength="45">
                                        </div>
                                        <div class="campo">
                                    ...
                                    <div class="campos">
                                        ...
                                        <div class="campo">
                                            ...
                                            <input type="text" id="conyuge" placeholder="Conyuge" maxlength="45">
                                        </div>                                                     
                                        <div class="campo">
                                    ...
                                    <div class="campos">
                                        <div class="campo">
                                            ...
                                            <input type="number" id="hijos" min='0' max='50'>
                                        </div>
                                    </div>
                                    <div class="campos">      
                                        <div class="campo">
                                            <label for="oficio">Oficio</label>
                                            <input type="text" id="oficio" placeholder="" maxlength="45">
                                        </div>
                                    </div>
                        ...
                        <div class="separador-form">                       
                            ...
                            <div class="campos">
                                <div class="campo">
                                    ...
                                    <input type="tel" id="telefono" placeholder="02224 123 456" maxlength="15">
                                </div>
                                <div class="campo">
                                    <label for="celular">Celular</label>
                                    <input type="tel" id="celular" placeholder="11 12345678" maxlength="15">
                                </div>
                                <div class="campo">
                                    <label for="mail">e-mail</label>
                                    <input type="email" id="mail" placeholder="usuario@correo.com" maxlength="30">
                                </div>                           
                            </div>
                        ...
                        <div class="separador-form">                       
                            ...
                            <div class="campos">
                                ...
                                <div class="campo">
                                    ...
                                    <input type="date" id="fechaMiembro" >
                                </div>   
                            </div>            
                            ...
                            <div class="campos">
                                <div class="campo">
                                    ...
                                    <input type="date" id="fconversion" >
                                </div>
                            ...
                            <div class="campos">
                                <div class="campo">
                                    ...
                                    <input type="text" id="iglesia" maxlength="45" >
                                </div>
                            </div>
                            <div class="campos">
                                <div class="campo">
