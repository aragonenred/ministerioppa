                   ...
                   //Limpiar la tabla
                    ...
                    if(resultado.personas){
                        for(i=0; i < resultado.personas.length; i++){
                            ...
                            row.innerHTML += '<td class="tb-icono"><a href="detalle.php?id=' + resultado.personas[i].idmiembro + '" class="td-detalle"> <i class="far fa-eye"></i></a></td> '
                            row.innerHTML += '<td class="tb-icono"><a href="editar.php?id='+ resultado.personas[i].idmiembro + '" class="td-editar"><i class="far fa-edit"></i></a></td>'
